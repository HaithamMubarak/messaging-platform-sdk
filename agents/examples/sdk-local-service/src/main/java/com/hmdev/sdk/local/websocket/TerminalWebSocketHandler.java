package com.hmdev.sdk.local.websocket;
...
public class TerminalWebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        log.debug("[WebSocket-Input] Session: {}, Data: {} (bytes: {})",
                 sessionId,
        ...
        try {
            ...
            if (needsEcho) {
                ...
                } else if (data.equals("\r") || data.equals("\r\n") || data.equals("\n")) {
                ...
                } else if (!data.isEmpty() && data.length() == 1 && data.charAt(0) >= 32 && data.charAt(0) < 127) {
                ...
                if (data.equals("\r") || data.equals("\r\n") || data.equals("\n")) {
                    ...
                    inputBuffer.setLength(0);
                } else if (data.equals("\u007F") || data.equals("\b")) {
                    if (inputBuffer.length() > 0) {
                        inputBuffer.deleteCharAt(inputBuffer.length() - 1);
                    }
                } else if (!data.isEmpty() && data.length() == 1 && data.charAt(0) >= 32) {
                    inputBuffer.append(data);
                }
            }
