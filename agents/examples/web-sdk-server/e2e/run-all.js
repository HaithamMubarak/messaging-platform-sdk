...
const GROUPS = {
    ...
    'apps': ['chat-test.js', 'wb-test.js', 'shape-fidelity-test.js', 'collab-actions-test.js', 'persistence-test.js', 'handover-test.js', 'rooms-test.js', 'term-test.js', 'terminal-scrollback-test.js', 'cloud-test.js',
             'drop-test.js', 'drop-resume-test.js', 'undriven-test.js', 'devpages-test.js', 'coreloop-test.js', 'dead-drop-test.js', 'under-the-hood-test.js', 'sponsorpulse-core-test.js', 'sponsorpulse-test.js',
             'fieldstamp-test.js'],
